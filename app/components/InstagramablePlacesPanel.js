...
export default function InstagramablePlacesPanel({
  ...
  useEffect(() => {
    const syncNotes = () => {
      if (!selectedCountry || !instagramablePlaces.length) return;
    ...
    syncNotes();
  }, [instagramablePlaces, selectedCountry]);
  ...
  if (!selectedCountry) {
    return (
      <div className="w-80 bg-white border-r border-gray-300 p-4">
        <h2 className="text-xl font-bold mb-4">Instagramable</h2>
    ...
    <div className="w-80 bg-white border-r border-gray-300 flex flex-col">
      ...
      {isAdminMode && (
        <div className="p-4 border-b border-gray-200">
          ...
          />
          <p className="text-xs text-gray-400 mt-2">Busca lugares o direcciones instagramables</p>
        </div>
      )}
            ...
            >
              ...
              {isAdminMode && (
                <div className="flex justify-end items-center pt-2 border-t border-gray-200 mt-2">
                  <button
                    onClick={() => onDeleteInstagramablePlace(place.id)}
